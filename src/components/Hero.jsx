    ...
    <section id="home" className="hero">
      ...
      <div className="hero__inner">
        ...
        <div className="hero__info">
          ...
          <h1 className="hero__name">Muhammad Usman</h1>
          ...
          <div className="hero__links">
            <a
              href="https://github.com/MuhammadUsman65"
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/muhammadusman65"
              target="_blank"
              rel="noreferrer"
              className="hero__link"
              title="LinkedIn"
            ...
            >
              <Mail size={18} />
              <span className="hero__callout hero__callout--right">
                <span className="hero__callout-line" />
                <span className="hero__callout-text">Email Me</span>
              </span>
            </a>
          </div>
        </div>
